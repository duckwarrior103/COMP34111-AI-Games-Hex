...
class MCTSNodeV0():
    def __init__(
        ...
        colour: Colour,
        board: Board,
        parent: "MCTSNodeV0 | None" = None
    ):
        self.board = board
        self.colour = colour

        self.parent = parent
        self.children: dict[Move, MCTSNodeV0] = {} # Key is move, value is a Node
    ...
    def make_move(self, move: Move) -> "MCTSNodeV0":
        ...
        child = MCTSNodeV0(Colour.opposite(self.colour), board_copy, self)
